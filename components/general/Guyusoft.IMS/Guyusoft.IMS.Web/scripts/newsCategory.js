...
app.controller('newsCategoryController', ['$scope', 'ngDialog', '$http', function ($scope, ngDialog, $http) {
    ...
    $scope.save = function () {
        $http.post('/NewsCategory/Edit', $scope.item).then(function (res) {
    ...
    $scope.remove = function () {
        $http.post('/NewsCategory/Delete', $scope.item).then(function (res) {
            if (res.data) {
